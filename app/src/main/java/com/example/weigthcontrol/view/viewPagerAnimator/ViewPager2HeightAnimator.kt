package com.example.weigthcontrol.view.viewPagerAnimator
...
class ViewPager2HeightAnimator {
    ...
    private fun getMeasuredViewHeightFor(view: View): Int {
        val largura = View.MeasureSpec.makeMeasureSpec(view.width, View.MeasureSpec.EXACTLY)
        val altura = View.MeasureSpec.makeMeasureSpec(0, View.MeasureSpec.UNSPECIFIED)

        view.measure(largura, altura)
